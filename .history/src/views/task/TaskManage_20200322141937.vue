                  ...
                  <div class="table-responsive">
                    ...
                    >
                      ...
                      <template v-slot:cell(scriptAction)="row">
                        ...
                        >
                          <nly-icon icon="fas fa fa-play-circle-o" />
                        </b-button>
                        <b-button
                          size="sm"
                          variant="danger"
...
export default {
  ...
  methods: {
    ...
    resetQueryCriteria() {
      ...
      this.$store.commit("setProjectManageDataFilterFormProjectName", "");
      this.$store.commit("setProjectManageDataFilterFormIsDetect", "");
      const toastVnode = {
        message: "重置成功",
        variant: "success",
        title: "操作成功",
