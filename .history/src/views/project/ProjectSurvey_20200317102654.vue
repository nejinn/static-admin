          ...
          <NLY-card-body class="collapse-wrap" v-show="cardBodyIsOpen">
            <b-row>
              ...
              <b-col lg="6" class="my-1">
                ...
                >
                  <b-form-select
                    v-model="filterForm.filterLoginRequired"
                    size="sm"
                    id="filterLoginRequired"
            ...
            <b-row>
              ...
              <b-col lg="6" class="my-1">
                <b-form-group
                  ...
                  label-align-sm="right"
                  label-size="sm"
                  label-for="filterScript"
                  class="mb-0"
                >
                  <b-form-select
                    v-model="filterForm.filterScript"
                    size="sm"
                    id="filterScript"
            ...
            <b-row>
              <b-col
                ...
                class="my-1"
              >
                <b-button-group class="nly-table-action-btn-group">
                  <b-button
                    size="sm"
                    @click="selectAllRows"
                    class="nly-table-action-btn"
                    variant="outline"
                    :pressed="true"
                    title="全选数据"
                  >
                    <b-icon
                      :icon="selectedAllRows ? 'check-box' : 'document'"
                      aria-hidden="true"
                      class="nly-table-action-btn-icons rounded-circle bg-primary p-1"
                      variant="light"
                    ></b-icon
                  ></b-button>
                  <b-button
                  ...
                  >
                    <b-icon
                      :icon="trash ? 'trash-fill' : 'trash'"
                      aria-hidden="true"
                      class="nly-table-action-btn-icons rounded-circle bg-danger p-1"
                      variant="light"
                    ></b-icon
                  ></b-button>
                  <b-button
                  ...
                  >
                    <b-icon
                      :icon="search ? 'arrow-repeat' : 'search'"
                      aria-hidden="true"
                      class="nly-table-action-btn-icons rounded-circle bg-success p-1"
                      variant="light"
                    ></b-icon
                  ></b-button>
                  <b-button
                  ...
                  >
                    <b-icon
                      :icon="reset ? 'x-circle-fill' : 'x-circle'"
                      aria-hidden="true"
                      class="nly-table-action-btn-icons rounded-circle bg-info p-1"
                      variant="light"
                    ></b-icon
                  ></b-button>
                  <b-button
                  ...
                  >
                    <b-icon
                      :icon="
                        refresh ? 'arrow-counterclockwise' : 'arrow-clockwise'
                      "
                      aria-hidden="true"
                      class="nly-table-action-btn-icons rounded-circle bg-warning p-1"
                      variant="light"
                    ></b-icon
                  ></b-button>
                  ...
                  >
                    <b-icon
                      icon="plus"
                      aria-hidden="true"
                      class="nly-table-action-btn-icons rounded-circle bg-pink p-1"
                      variant="light"
                    ></b-icon
                  ></b-button>
                </b-button-group>
...
<script>
import projectSurveyTable from "./_projectSurveyTable.js";
export default {
  name: "ProjectManage",
  data() {
    return {
