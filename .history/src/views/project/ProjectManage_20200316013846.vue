        ...
        <NLY-card-header>
          <b-row>
            ...
            <NLY-card-header-tools>
              <NLY-hover-icon
                icon="nlyfont nly-refresh-fill"
                variant="nlyinfo"
                @click.native="refreshCardDate"
              />
              <NLY-hover-icon
                icon="nlyfont nly-screenfull-fill"
                variant="nlywarning"
                @click.native="setCardScreenFull"
              />
              <NLY-hover-icon
                icon="nlyfont nly-remove-fill"
                variant="nlyprimary"
                @click.native="changeCardOpen"
              />
            </NLY-card-header-tools>
          </b-row>
        </NLY-card-header>
              ...
              >
                <b-button-group class="nly-table-action-btn-group">
                  <NLY-hover-icon
                    :icon="
                      selectedAllRows
                        ? 'nlyfont nly-checkbox-fill'
                        : 'nlyfont nly-checkbox'
                    "
                    variant="nlyprimary"
                    size="lg"
