...
<script>
import surveyViewResult from "./_surveyViewResult.js";
export default {
  name: "surveyViewResult",
  data() {
    return {
      cardHeaderTitle: surveyViewResult.name + "-" + this.$route.params.name,
      cardBodyIsOpen: true,
      fields: surveyViewResult.fields,
      items: null,
      selected: [],
  ...
  mounted() {
    ...
    this.$WYHttp.survey.getSurveyResultList(obj, params);
  },
  created() {
    this.currentPage = 1;
    this.perPageSize = 10;
