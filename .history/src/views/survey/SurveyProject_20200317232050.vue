                ...
                <div class="table-responsive">
                  ...
                  >
                    ...
                    <template v-slot:cell(isLogin)="data">
                      <nly-badge
                        :bg-variant="data.value == '是' ? 'orange' : 'maroon'"
                    ...
                    <template v-slot:cell(scriptStatus)="data">
                      <nly-badge
                        :bg-variant="data.value == '停止' ? 'orange' : 'maroon'"
                        badge-class="text-white"
                      >
                        {{ data.value }}
                      </nly-badge>
...
export default {
  ...
  methods: {
    ...
    queryData() {
      if (this.keyWord == "") {
        ...
        let toastData = {
          ...
          variant: "success",
          title: "操作成功",
          content: `搜索关键词为: ${this.keyWord}  的数据`
        };
        ...
        this.$WYHttp.survey.querySurveyList(obj, params, toastData);
      }
    },
    // 重置查询条件
    resetQueryCriteria() {
    ...
    refreshDate() {
      ...
      this.$WYHttp.survey.refreshSurveyList(obj, params, toastData);
    },
    goView(row) {
      this.$router.push({
        name: "ProjectView",
    ...
    refreshCardDate() {
      ...
      this.$WYHttp.survey.getCardSurveyList(obj, params, toastData);
    },
    // 收起卡片
    changeCardOpen() {
