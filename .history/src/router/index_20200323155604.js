...
const SurveyViewMore = () => import("../views/survey/SurveyViewMore.vue");
const SurveyViewMoreResult = () =>
  import("../views/survey/SurveyViewMoreResult.vue");
        ...
        children: [
          {
            ...
            children: [
              ...
              {
                path: "result/add",
                name: "SurveyViewMoreResult",
                component: SurveyViewMoreResult,
                meta: {
                  title: "新增探测结果",
                  containerActive: false,
                  requireLogin: true,
