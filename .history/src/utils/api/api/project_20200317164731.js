  ...
  deletePojectDetail: function(obj, data, toastData) {
    ...
    http.wyPost(url, data).then(
      ...
      response => {
        ...
        console.log("totalPages0", obj.totalPages);
        http.wyPost(nextUrl, nextParams).then(nextResponse => {
          const nextTotal = nextResponse.count;
          const nextTotalPages = Math.ceil(nextTotal / obj.pageSize);
          const nextCurrentPage =
            nextTotalPages < obj.totalPages ? nextTotalPages : obj.totalPages;

          console.log("totalPages", obj.totalPages);
          console.log("nextTotalPages", nextTotalPages);
          console.log("nextCurrentPage", nextCurrentPage);
